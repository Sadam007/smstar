...
<header class="app-header">
        ...
        <div class="top-bar">
          ...
          <div class="top-bar-brand">
             <a href="{{ route("sdashboard") }}" style="font-weight: 500;line-height: 1rem;">Special Users Dashboard</a>
          </div>
          <!-- /.top-bar-brand -->
          <!-- .top-bar-list -->
          <div class="top-bar-list">
            ...
            <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
                    ...
                    <div class="dropdown-scroll has-scrollable">
                      ...
                      <a href="#" class="dropdown-item unread">
                        <div class="user-avatar">
                          <img src="{{asset('backend/images/avatars/uifaces15.jpg')}}" alt=""> </div>
                      ...
                      <a href="#" class="dropdown-item unread">
                        <div class="user-avatar">
                          <img src="{{asset('backend/images/avatars/uifaces16.jpg')}}" alt=""> </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="{{asset('backend/images/avatars/uifaces17.jpg')}}" alt=""> </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="{{asset('backend/images/avatars/uifaces18.jpg')}}" alt=""> </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="{{asset('backend/images/avatars/uifaces19.jpg')}}" alt=""> </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="{{asset('backend/images/avatars/uifaces20.jpg')}}" alt=""> </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="{{asset('backend/images/avatars/uifaces21.jpg')}}" alt=""> </div>
                        <div class="dropdown-item-body">
              ...
              <div class="dropdown">
                <button class="btn-account d-none d-md-flex" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="user-avatar user-avatar-md">
                  <img src="{{ asset("backend/images/avatars/profile.jpg") }}" alt=""></span> <span class="account-summary pr-lg-4 d-none d-lg-block"><span class="account-name">
                    {{ strtoupper(Auth('specialuser')->user()->username)  }}</span> <span class="account-description">Administrator</span></span>
                </button>
              ...
              <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="{{ route('specialuser.logout') }}" onclick="event.preventDefault();
                  document.getElementById('logout-form').submit();"><span class="dropdown-icon oi oi-account-logout"></span>  {{ __('Logout') }}</a>

                  <form id="logout-form" action="{{ route('specialuser.logout') }}" method="POST" style="display: none;">
                    @csrf
                  </form>
