...
@section('page-title')
<title> Exam Portal | Colleges Management | Create Colleges Users</title>
@endsection
            ...
            <div class="page-section">
               ...
               <section id="base-style" class="card">
                  <div class="card-body">
                     <form  id="collegeUsersForm" autocomplete="off">
                        {{ csrf_field() }}
                        <fieldset>
                           <legend>College Users Management Area</legend>
               ...
               <section class="card card-fluid" id="table-show">
                  ...
                  <div class="card-body">
                     ...
                     <div class="text-muted"> Showing {{ $staffusers->firstItem() }} to {{ $staffusers->lastItem() }} of {{$staffusers->total()}} entries </div>
...
<script>
  ...
  var base_url  = '{{ URL::to("/") }}/';
   $('#BtnSubmit').on('click',function(){
      $("form#collegeUsersForm").validate({
         ...
         submitHandler:function(form, e){
            ...
            var url="<?php echo route('staffpost');?>";
            var cur_url="<?php echo route('createstaff');?>";
           axios({
            method: 'POST',
            url: url,
            data: {
         ...
         .catch(function(err){
            setTimeout(()=>{toastr.warning("Staff does not created username already exists");
         },1000);
            img.setAttribute("src","");
            btn.style.display="block";
            loader.style.display="none";
   ...
   $("button.btn-inactive").click(function(event) {
        ...
        var id = $(this).data('id');
        var url = "/special/staffuserinactive/";
   ...
   $("button.btn-active").click(function(event) {
        ...
        var id = $(this).data('id');
        var url = "/special/staffuseractive/";
