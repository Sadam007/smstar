                      ...
                      @foreach($degrees as $degree)
                           <tr>
                            <td class="align-middle">
                              <a href="{{ route('degAdmin.degrees.semesters',['degree'=>$degree->degree_id]) }}"> {{ $degree->Det1 }} 
                              </a>
                            </td>
                                                      
                            <td class="align-middle"> 
                              <center>
                                <button type="submit" class="btn btn-outline-primary btn-sm"><i class="fa fa-bullhorn" aria-hidden="true"></i> &nbsp;Promote</button>  
                              </center>
                            </td>
                          </tr>
