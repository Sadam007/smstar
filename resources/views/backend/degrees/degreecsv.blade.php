@extends('layouts.app')
@section('page-title')
<title> Exam Portal | Degrees Management | Add Degree</title>
@endsection
      ...
      <div class="page-section">
        ...
        <section id="base-style" class="card">
          <div class="card-body">
            <form  id="uploadCsvForm" autocomplete="off">
              {{ csrf_field() }}
              <fieldset>
                <legend>Degree Management Area</legend>
        ...
        <section class="card card-fluid" id="table-show">
          <header class="card-header">
            <legend>All Registered Degrees</legend>
          </header>
          <div class="card-body">
            <div class="form-group">
              ...
              <table class="table">
                  ...
                  <tr>
                    <th colspan="2" style="min-width:200px">
                      <div class="thead-dd dropdown">
                        ...
                        <span style="margin-left: 10px;">Degree Title</span>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <?php
                    //$collegelower = strtolower($degree->M_Title);
                    
                    ?>
                    <td class="align-middle"> {{  $degree->M_Title }}</td>
                    <td class="align-middle">  {{ $degree->Det1 }}</td>
                    <td class="align-middle text-right">
                      <button type="button" href="#edit<?php echo $degree->id;?>" class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#edit<?php echo $degree->id;?>">
                      <i class="fa fa-pencil-alt"></i>
                      <span class="sr-only">Edit</span>
                      </button>
                      <button type="button" href="#delete<?php echo $degree->id;?>" class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#delete<?php echo $degree->id;?>">
                  ...
                  @include('backend.includes.modals.edit-degrees-modal')
                  @include('backend.includes.modals.delete-degrees-modal')
...
var url="<?php echo route('degreecsvpost');?>";
var cur_url="<?php echo route('degreecsv');?>";
