...
@section('page-title')
<title> Exam Portal | Colleges Management | Add College Degrees</title>
@endsection
...
<div class="wrapper">
         ...
         <header class="page-title-bar">
            ...
            <div class="page-section">
               ...
               <section id="base-style" class="card">
                  <div class="card-body">
                     <form  id="uploadDegreesCsvForm" autocomplete="off">
                        {{ csrf_field() }}
                        <fieldset>
                           <legend>College Degrees Management Area</legend>
   ...
   <div class="page-sidebar page-sidebar-fixed">
      ...
      <nav id="nav-content" class="nav flex-column mt-4">
         ...
         <a href="{{ route('degreescsv') }}" class="nav-link smooth-scroll">College Degrees</a>
...
<script>
   ...
   $('#BtnSubmit').on('click',function(){
      $("form#uploadDegreesCsvForm").validate({
         errorElement:'span',
         ...
         submitHandler:function(form,e){
            ...
            var url ="<?php echo route('collegedegreescsvpost');?>";
            var cur_url="<?php echo route('degreescsv');?>";
         ...
         .then(function(res){
            ...
            if(good==true){
               ...
               $('body').load(document.URL+'#uploadDegreesCsvForm');
            }
         })
         .catch(function(err){
