...
<div class="modal-footer">
  <div style="margin-top: 20px !important;">
   <a  href="{{route('examdelete',['id'=>$exam->exam_id])}}" data-id="<?php echo $exam->exam_id;?>" class="btn btn-sm btn-outline-primary  btn-del">Yes <i class="far fa fa-check" aria-hidden="true"></i>
   </a>
