...
@section('page-title')
<title> Exam Portal | Exams Management | Export Students</title>
@endsection
...
<section id="base-style" class="card">
  <div class="card-body">
   <form  id="uploadCsvForm" autocomplete="off">
    {{ csrf_field() }}
    <fieldset>
     <legend>Students Export Management Area</legend>
...
submitHandler:function(form,e){
    ...
    var url="<?php echo route('export.students-process');?>";
    var cur_url="<?php echo route('export.students');?>";
