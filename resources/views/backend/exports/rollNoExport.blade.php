...
@section('page-title')
<title> Exam Portal | Exams Management | Export Roll No Records</title>
@endsection
...
<section id="base-style" class="card">
  <div class="card-body">
   <form  id="uploadCsvForm" autocomplete="off">
    {{ csrf_field() }}
    <fieldset>
     <legend>Roll No  Export Management Area</legend>
...
submitHandler:function(form,e){
    ...
    var url="<?php echo route('export.rollno-process');?>";
    var cur_url="<?php echo route('export.rollno');?>";
