...
<td class="align-middle"> {{ $center->cname}} </td>
<td class="align-middle text-right">
    <button type="button" href="#edit<?php echo $center->ccode_id;?>" class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#edit<?php echo $center->ccode_id;?>">
     <i class="fa fa-pencil-alt"></i>
     <span class="sr-only">Edit</span>
 </button>
 <button type="button" href="#delete<?php echo $center->ccode_id;?>" class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#delete<?php echo $center->ccode_id;?>">
...
@include('backend.includes.modals.edit-center-modal')
@include('backend.includes.modals.delete-center-modal')
