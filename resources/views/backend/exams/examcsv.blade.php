...
@section('page-title')
<title> Exam Portal | Exams Management | Add Exam</title>
@endsection
...
<section id="base-style" class="card">
  <div class="card-body">
   <form  id="uploadCsvForm" autocomplete="off">
    {{ csrf_field() }}
    <fieldset>
     <legend>Exams Management Area</legend>
...
<div class="text-muted"> Showing {{ $exams->firstItem() }} to {{ $exams->lastItem() }} of {{$exams->total()}} entries </div>
...
<td>        
    <a href="#" style="margin-left: 10px;">{{ $exam->addedby}}</a>
</td>
<td class="align-middle"> {{ $exam->examcode}} </td>
<td class="align-middle"> {{ $exam->description}} </td>
<td class="align-middle"> {{ $exam->type}} </td>
<td class="align-middle text-right">
    <button type="button" href="#edit<?php echo $exam->exam_id;?>" class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#edit<?php echo $exam->exam_id;?>">
     <i class="fa fa-pencil-alt"></i>
     <span class="sr-only">Edit</span>
 </button>
 <button type="button" href="#delete<?php echo $exam->exam_id;?>" class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#delete<?php echo $exam->exam_id;?>">
...
submitHandler:function(form,e){
    ...
    var url="<?php echo route('examcsvpost');?>";
    var cur_url="<?php echo route('examcsv');?>";
